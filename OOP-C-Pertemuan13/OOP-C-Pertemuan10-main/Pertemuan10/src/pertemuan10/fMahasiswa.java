...
/**
 *
 * @Archangela Chirani Yehan
 * TGL:13 Juni 2025 2025
 */
public class fMahasiswa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txJUR.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                txJURPropertyChange(evt);
            }
        });
    ...
    private void cTUTUPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cTUTUPActionPerformed
       if (cTUTUP.getText().equals("Tutup")){
           int opsi = JOptionPane.showOptionDialog( this,
                   "Yakin akan menutup Aplikasih ?",
                   "Konfirmasi Tutup Apikasih",
                   JOptionPane.YES_NO_OPTION,
                   JOptionPane.QUESTION_MESSAGE,
                   null, null, null);
    ...
    private void txJURPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_txJURPropertyChange
        // TODO add your handling code here:
    }//GEN-LAST:event_txJURPropertyChange
 ...
 private void destoroyData() throws SQLException {
       Connection cnn = koneksi();
       String nim = txNIM.getText();
